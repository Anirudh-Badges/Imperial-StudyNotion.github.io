...
const GetInTouchForm = ({title, description}) => {
    ...
    return (
        <div>
            <div className='flex flex-col items-center mx-auto mt-10 gap-4' >
                <h1 className='text-3xl text-richblack-5 font-semibold'> {title}</h1>
                <p className='text-richblack-500 -ml-8'>{description}</p>
            </div>

            <form onSubmit={handleOnSubmit} className="flex flex-col gap-y-3 w-[80%] items-center mx-auto mt-10 mb-10">
